...
class ProductEditCtrl {
    ...
    public function validateSave() {
        ...
        $this->form->name = $v->validateFromPost('name', [
            ...
            'min_length' => 2,
            'max_length' => 64,
            'validator_message' => 'Nazwa produktu powinna zawierać od 2 do 64 znaków'
        ]);

        $this->form->manufacturer = $v->validateFromPost('manufacturer', [
            'trim' => true,
            'required' => true,
            'required_message' => 'Podaj nazwę producenta',
            'min_length' => 2,
            'max_length' => 64,
            'validator_message' => 'Nazwa produktu powinna zawierać od 2 do 64 znaków'
        ]);
        
        $this->form->color = $v->validateFromPost('color', [
            'trim' => true,
            'required' => true,
            'required_message' => 'Podaj color',
            'min_length' => 2,
            'max_length' => 64,
            'validator_message' => 'Nazwa produktu powinna zawierać od 2 do 64 znaków'
        ]);
        ...
        $this->form->material = $v->validateFromPost('material', [
            'trim' => true,
            'required' => true,
        ...
        $this->form->size = $v->validateFromPost('size', [
            'trim' => true,
            'required' => true,
            'required_message' => 'Podaj poprawny rozmiar',
            'min_length' => 0,
            'max_length' => 200,
            'validator_message' => 'Opis może zawierać maksymalnie 200 znaków'
        ]);
    ...
    public function action_productEdit() {
        ...
        if ($this->validateEdit()) {
            try {
                ...
                $this->form->material = $record['material'];
                $this->form->size = $record['size'];
